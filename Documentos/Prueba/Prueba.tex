...
\clearpage
\appendix
\noappendicestocpagenum %evita que el título de apendices en la toc esté numerado
\addappheadtotoc %título de apéndices en la toc
\appendixpage %título apéndices en el documento
